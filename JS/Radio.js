...
const icons = [
    {
        radioName:`情感`,
        changeI:`bi bi-chat-left-text`
    },
    {
        radioName:`音乐播客`,
        changeI:`bi bi-boombox`
    },
    {
        radioName:`有声书`,
        changeI:`bi bi-book`
    ...
    {
        radioName:'创作翻唱',
        changeI:'bi bi-earbuds'
    },
    {
        radioName:'电音',
        changeI:'bi bi-activity'
    },
    {
        radioName:'知识',
        changeI:'bi bi-journals'
    },
    {
        radioName:'二次元',
        changeI:'bi bi-bounding-box'
    },
    {
        radioName:'明星专区',
        changeI:'bi bi-camera-reels'
    },
    {
        radioName:'文字出版',
        changeI:'bi bi-chat-text'
    },
    {
        radioName:'常见问题',
        changeI:'bi bi-search'
    },
    {
        radioName:'生活',
        changeI:'bi bi-arrow-through-heart-fill'
    },
    {
        radioName:'亲子',
        changeI:'bi bi-backpack2'
    },
    {
        radioName:'资讯',
        changeI:'bi bi-bank'
    ...
    {
        radioName:'广播剧',
        changeI:'bi bi-broadcast'
    },
    {
        radioName:'故事',
        changeI:'bi bi-card-checklist'
    },
    {
        radioName:'人文历史',
        changeI:'bi bi-calendar-date'
    },
    {
        radioName:'娱乐',
        changeI:'bi bi-controller'
    },
    {
        radioName:'相声曲艺',
        changeI:'bi bi-columns-gap'
    },
    {
        radioName:'其他',
        changeI:'bi bi-three-dots'
    },
]
Array.from(document.getElementsByClassName('iconItem')).forEach((element, i) => {
    element.getElementsByTagName('i')[0].className = icons[i].changeI 
    element.getElementsByTagName('h5')[0].innerHTML = icons[i].radioName 
});
...
let right_move = document.getElementById('right_move');
let radio_icon = document.getElementsByClassName('radio_icon')[0];

left_move.addEventListener('click', () => {
    radio_icon.scrollLeft -= 330;
})
